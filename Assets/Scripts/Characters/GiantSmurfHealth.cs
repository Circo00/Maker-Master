...
public class GiantSmurfHealth : MonoBehaviour
{

    Collider childcollider;
    private SmurfCatScript smurfcatscript;
    ...
    void Start()
    {
        ...
        smurfcatscript = GetComponent<SmurfCatScript>();
    }
